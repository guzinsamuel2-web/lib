--[[
    =====================================================================
    UI Library + Ilha Bela 2.0 Integration
    Professional Roblox UI with Farm/Uber/Erva Systems
    =====================================================================
]]
...
local function TpTo(pos)
    ...
    local u = dir.Unit
    while true do
        if not (Toggles.AutoIfood or Toggles.AutoFarmGari or Toggles.AutoFarmGariTPTO) then return false end
        local h = GetHRP()
...
HomeSection:CreateParagraph({
    Name = "Informações",
    Content = "Sistema completo de Farm com Auto Ifood, Gari, Uber e Erva. Configure nas abas ao lado!"
})
...
GariSection:CreateToggle({
    ...
    Callback = function(state)
        ...
        if state then
            ...
            Notify("Auto Farm Gari", "Iniciado! ✓")
        else
...
local UberTab = Window:CreateTab({
    Name = "Uber",
    Icon = "rbxassetid://10651113645"
})
...
local AntiSection = SystemTab:CreateSection("Anti")
...
local EnvironmentSection = SystemTab:CreateSection("Ambiente")
...
EnvironmentSection:CreateButton({
    ...
    Callback = function()
        ...
        Notify("Lighting", "Resetado!")
    end
})

print("✓ Ilha Bela 2.0 Pro - Carregado com sucesso!")
Notify("Ilha Bela 2.0 Pro", "Script carregado! ✓", 5)
